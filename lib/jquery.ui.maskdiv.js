(function() {
  ...
  $.widget("ui.maskDiv", {
    ...
    _handle_blur_mask: function(e) {
      ...
      this.current_position = this._get_mask_html(this._text_minus_dividers())[1]
      el_text.splice(this.current_position + this._dividers_before_current_position(), el_text.length);
